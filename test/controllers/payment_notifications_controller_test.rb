...
class PaymentNotificationsControllerTest < ActionController::TestCase
  ...
  test "should create payment_notification" do
    assert_difference('PaymentNotification.count') do
      post :create, payment_notification: { cart_id: @payment_notification.cart_id, create: @payment_notification.create, params: @payment_notification.params, status: @payment_notification.status, transaction_id: @payment_notification.transaction_id }
    end
